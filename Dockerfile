...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-progress-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-progress-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-progress-api/bin/ocp-progress-api .
RUN chown root:root ocp-progress-api
EXPOSE 8080
EXPOSE 8082
CMD ["./ocp-progress-api"]